...
export default function PricingPage() {
  ...
  const pricingPlans = [
    ...
    },
    {
      ...
      description:
        'Intraday strategy optimized for GBP/USD & SPY with 97% win rate and superior profit factor.',
      features: [
  ...
  /* ────────────────────────────────────────── render ────────────────── */
  return (
    {/* 7-rem top padding so content clears the fixed header */}
    <div className="pt-28 bg-black text-white min-h-screen font-sans overflow-x-hidden box-border">
