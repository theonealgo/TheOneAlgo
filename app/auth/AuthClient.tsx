...
export default function AuthClient() {
  ...
  async function handleSignup(e: FormEvent<HTMLFormElement>)  {
    ...
    // 2) if signup failed, show returned friendly message
    if (!r1.ok) {
    ...
    // 3) continue with saving TV user and Stripe session
  ...
  function handleGoogle() {
    // Launch Google sign-in and let NEXTAUTH_URL handle the redirect URI
